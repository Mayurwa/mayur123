...
public class PerformTransactionService {
	...
	public void updateTransactionDetails(TransactionDetailsVO transaction,Long accountNumber) throws  InvalidAccountBalance {
		//ptDAO.updateTransactionDetails(accountNumber);
		  User user=ptDAO.updateTransactionDetails(accountNumber);
		...
		private void updateUser(int transactionAmount, User user,String transactionType) throws InvalidAccountBalance {
			int newBalance=0;
